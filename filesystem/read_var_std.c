...
void help_read_var_std(){
	printf("\n");
	printf("read_var_std\n");
	printf("Obter valor de variavel em arquivo onde cada linha possui um par VAR=VALUE,\n");
	printf(" retorna valor padrao caso o valor encontrado esteja vazio.\n");
	printf("\n");
	printf("Autor: Patrick Brandao <patrickbrandao@gmail.com>, todos os direitos reservados\n");
	printf("\n");
	printf("Use: read_var_std (file) (varname) (default-value)\n");
...
int main_read_var_std(const char* progname, const int argc, const char **argv){
