...
void help_str_random(){
	printf("\n");
	printf("str_random\n");
	printf("Gera caracteres aleatoriamente e permite controlar Retorna apenas os caracters permitidos sem uso de regex.\n");
	printf(" Parametros:\n");
	...
	printf("\n");
	printf("Use: str_random (sting) (opt) [opt] [opt]\n");
	printf("\n");
	exit(1);
}
...
int main_str_random(const char *progname, const int argc, const char **argv){
